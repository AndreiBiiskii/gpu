# Generated by Django 5.0.6 on 2024-11-17 17:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True, verbose_name='Позиция по ГП')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='descriptions', to='device.equipment', verbose_name='Описание оборудования')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='model',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='model', to='device.equipmentmodel'),
        ),
        migrations.AddField(
            model_name='equipment',
            name='name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='n', to='device.equipmentname', verbose_name='Наименование оборудования'),
        ),
        migrations.AddField(
            model_name='equipment',
            name='type',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='type', to='device.equipmenttype', verbose_name='Тип'),
        ),
        migrations.CreateModel(
            name='Location',
            fields=[
                ...
                ('equipment', models.ForeignKey(default='NoneLocation', on_delete=django.db.models.deletion.CASCADE, related_name='locations', to='device.equipment', verbose_name='Место установки')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='equipment',
            name='manufacturer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='manufacturer', to='device.manufacturer', verbose_name='Производитель'),
        ),
        migrations.CreateModel(
            name='Position',
            fields=[
                ...
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='positions', to='device.equipment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status', to='device.equipment', verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_draft', models.CharField(max_length=255, verbose_name='Место установки')),
                ('tag_draft', models.CharField(max_length=255, verbose_name='Тэг')),
                ('description_draft', models.TextField(verbose_name='Описание')),
                ...
                ('poz_draft', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='device.gp', verbose_name='Поз. по ГП')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate', models.CharField(default='еще нет', max_length=255, verbose_name='Свидетельство о поверке')),
                ('result', models.BooleanField(default=True)),
                ('com', models.TextField(default='none', verbose_name='Комментарий')),
                ('equipment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='si', to='device.equipment', verbose_name='Средство измерения')),
                ...
                ('scale', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='scale', to='device.scale', verbose_name='Шкала датчика')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='unit', to='device.unit', verbose_name='Единица измерения')),
                ('interval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='interval', to='device.verificationinterval', verbose_name='Межповерочный интервал (мес)')),
            ],
            options={
